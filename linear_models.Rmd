...
This plot shows that model 1 had a lower Root Mean Squared Error compared to Model 2 and 3 and therefore consistently out predicts the model 2 of `blength` and `gaweeks` and 3 which uses `bhead`, `blength`, `babysex`, and their interaction term. 
